...
#define PID_TORQUE_KP_DEFAULT         3073
#define PID_TORQUE_KI_DEFAULT         538
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           3073
#define PID_FLUX_KI_DEFAULT           538
...
#define PID_SPEED_KP_DEFAULT          3409/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT          305/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define DEFAULT_CONTROL_MODE           STC_SPEED_MODE /*!< STC_TORQUE_MODE or
                                                        STC_SPEED_MODE */
#define DEFAULT_TARGET_SPEED_RPM      200
